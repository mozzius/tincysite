...
export async function AggregateStats() {
  ...
  const res = await fetch(
    `https://plausible.io/api/v1/stats/aggregate?site_id=${site}&metrics=visitors,visits,pageviews,bounce_rate,visit_duration`,
  ...
  if (!parse.success) {
    return <div className="my-10 text-center">API returned a funky result</div>;
  }
